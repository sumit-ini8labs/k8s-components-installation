...
![Envoy AI Gateway Architecture Diagram](architecture_diagram.png)

![Secondary Architecture View](architecture_dia2.png)
...
![Resource Relationships](resource_relationship.png)
...
![Envoy AI Gateway Architecture Diagram](envoy_architecture_diagram.png)
...
![OpenAI Key Configuration](Open_ai_key_insert.png)
...
![All Installed Components](all-installed-components.png)
...
![Inference Pool Flow](test_with_inference_pool.png)
...
Here is a complete example showing how to configure a Gateway to route to an Inference Pool for specific models. This YAML defines the `GatewayClass`, `Gateway`, and `AIGatewayRoute`.
...
We use a `BackendTrafficPolicy` to define these limits. The following example restricts a user to 100 tokens per hour for the `gpt-4o-mini` model.
